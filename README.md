...
v4 新增的强势成长观察不再只看短线热度，而是把 20/60/120 日强度和距 120 日高点位置写入候选快照与 SQLite，避免尚未加速的价值/主线核心候选被短期强势股全部挤出。
...
- 结构锚点和 50%/62.5%/75%价位；
- 上扬 MA20/MA60 拉回；
- W底、跳空长阳、窄幅平台、U50/R50、量价节点和连阳一半等右侧主结构；
...
var/data/my_trade.sqlite3  结构化研究数据和回测结果
