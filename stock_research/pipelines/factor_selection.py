...
def run_akshare_cache_fallback(top):
    ...
    """
    cache_dir = str(PATHS.cache / "formula33_kline" / "akshare")
    ...
    name_map = {}
    universe_cache = str(PATHS.cache / "stock_universe.csv")
    try:
...
from stock_research.indicators import factors as _factor_indicators
from stock_research.strategies import factor_selection as _factor_strategy

parse_yi = _factor_indicators.parse_yi
parse_pct = _factor_indicators.parse_pct
parse_float = _factor_indicators.parse_float
clamp = _factor_indicators.clamp
score_direct = _factor_indicators.score_direct
score_inverse = _factor_indicators.score_inverse
remove_outliers = _factor_indicators.remove_outliers
classify_selection_bucket = _factor_strategy.classify_selection_bucket
build_risk_flags = _factor_strategy.build_risk_flags
